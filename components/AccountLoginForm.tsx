...
import { accountLogin, type AccountLoginState } from "@/app/account/actions";

const initial: AccountLoginState = {};

export function AccountLoginForm() {
  const [state, formAction, pending] = useActionState(accountLogin, initial);
